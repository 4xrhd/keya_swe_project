...
### 6.3 References
*   **[R1]** Meta Open Source, "React – A JavaScript library for building user interfaces," 2026. [Online]. Available: https://react.dev.
*   **[R2]** Microsoft Corporation, "TypeScript: JavaScript with syntax for types," 2026. [Online]. Available: https://www.typescriptlang.org.
*   **[R3]** E. You et al., "Vite: Next Generation Frontend Tooling," 2026. [Online]. Available: https://vite.dev.
*   **[R4]** M. F. Porter, "An algorithm for suffix stripping," *Program: electronic library and information systems*, vol. 14, no. 3, pp. 130-137, 1980.
*   **[R5]** D. Jurafsky and J. H. Martin, *Speech and Language Processing*, 3rd ed. draft, 2024. [Online]. Available: https://web.stanford.edu/~jurafsky/slp3/.
*   **[R6]** W3C Web Speech API Draft Specification, "Web Speech API," Jan. 2023. [Online]. Available: https://wicg.github.io/speech-api/.
*   **[R7]** Translated SRL, "MyMemory API – Free Multilingual Translation Service," 2026. [Online]. Available: https://mymemory.translated.net/doc/spec.php.
*   **[R8]** "IEEE Recommended Practice for Software Requirements Specifications," *IEEE Std 830-1998*, IEEE Computer Society, Oct. 1998.
*   **[R9]** Keya Project Documentation, "Master Project References," May 2026. [Online]. See: [14.References.md](./14.References.md).
